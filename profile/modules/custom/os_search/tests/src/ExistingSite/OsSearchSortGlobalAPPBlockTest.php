 ...
 * @group os-search
 * @group kernel
 * @covers \Drupal\os_search\Plugin\Block\OsSearchSortGlobalAPPBlock
 */
class OsSearchSortGlobalAPPBlockTest extends OsExistingSiteTestBase {
  ...
  public function test() {
    ...
    foreach ($enabled_apps as $app) {
      ...
      $is_exists = $page->hasContent('Relevance');
